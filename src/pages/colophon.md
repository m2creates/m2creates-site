...
<div class="palette-grid">
  <div class="swatch s-charcoal">
    <span class="swatch-name">Near-Black</span>
    <span class="swatch-hex">#0f1614</span>
    <span class="swatch-role">Scorpio Rising</span>
  </div>
  <div class="swatch s-forest">
    <span class="swatch-name">Forest</span>
    <span class="swatch-hex">#1a2420</span>
    <span class="swatch-role">Yang Wood</span>
  </div>
  <div class="swatch s-sage">
    <span class="swatch-name">Sage</span>
    <span class="swatch-hex">#7a9e8e</span>
    <span class="swatch-role">Primary</span>
  </div>
  <div class="swatch s-violet">
    <span class="swatch-name">Violet</span>
    <span class="swatch-hex">#5c6aad</span>
    <span class="swatch-role">Aquarius Sun</span>
  </div>
  <div class="swatch s-gold">
    <span class="swatch-name">Gold</span>
    <span class="swatch-hex">#c9a24a</span>
    <span class="swatch-role">Sagittarius Moon</span>
  </div>
</div>
...
The technical stack was chosen for the same reason as everything else on this site: coherence with how the work actually gets done.
