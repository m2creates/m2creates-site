module.exports = ({ prompt, challengers, results, submission } = {}) => `
  <div class="not-prose callout flex flex-col items-center justify-between gap-4 w-full px-5 py-4 my-8 text-white no-underline bg-purple-600">
    <p class="w-full text-center"><span class="font-bold uppercase text-sm">Prompt:</span><br><span class="text-2xl">“<em>${prompt}</em>”</span></p>
